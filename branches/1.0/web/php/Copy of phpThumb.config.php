...
if (mysql_escape_string(@$_GET['id']) != "") {
  $PHPTHUMB_CONFIG['mysql_query'] = 'SELECT `picture` FROM options WHERE (`optionid` = \''.mysql_escape_string(@$_GET['id']).'\')';
} else {
  $PHPTHUMB_CONFIG['mysql_query'] = '';
}
...
$PHPTHUMB_CONFIG['mysql_username'] = 'BESTool';
$PHPTHUMB_CONFIG['mysql_password'] = 'best57';
$PHPTHUMB_CONFIG['mysql_database'] = 'bestool';
