 ...
 * @version    SVN: $Id: sfContext.class.php 3077 2006-12-18 08:52:37Z fabien $
 */
class sfContext
{
  protected
  ...
  public function retrieveObjects($class, $peerMethod, $peerMethodArg=null)
  {
    return $this->databaseManager->getDatabase(constant("$class::DATABASE_NAME"))->retrieveObjects($class, $peerMethod, $peerMethodArg);
  }
