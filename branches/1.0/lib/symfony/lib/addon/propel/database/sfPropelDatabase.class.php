...
class sfPropelDatabase extends sfCreoleDatabase
{
  ...
  public function retrieveObjects($class, $peerMethod = null, $peerMethodArg=null)
  {
    ...
    $arg = $peerMethodArg ? $peerMethodArg : new Criteria(); //Custom code
		$objects = call_user_func(array($classPeer, $peerMethod), $arg); //Custom code
		
    //$objects = call_user_func(array($classPeer, $peerMethod), new Criteria()); //Replaced by custom code
